...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, TestKMDFControlDriver1QueueInitialize)
#endif

NTSTATUS
TestKMDFControlDriver1QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = TestKMDFControlDriver1EvtIoDeviceControl;
    queueConfig.EvtIoStop = TestKMDFControlDriver1EvtIoStop;
...
VOID
TestKMDFControlDriver1EvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
